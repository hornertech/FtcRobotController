...
public class FFautoWITHvuforia extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Log.i(TAG, "Position deteceted" + position);
        /*
        Robot.moveForwardToPosition(0.5, 15);
        Robot.moveLeftToPosition(0.5, 30);
        Robot.moveLeftForTime(0.3, 1000, false);
        Robot.moveBackwardToPosition(0.2, 8);
        Robot.carouselmove(3600);
        Robot.moveForwardToPosition(0.5, 36);
        Robot.turnWithPower(1);
        sleep(3000);
        Robot.turnOff();
        Robot.moveBackwardForTime(0.2, 2000, false);
        Robot.moveForwardToPosition(0.5, 36);
        Robot.drop();
