...
@TeleOp(name="CapstoneTest", group = "Concept")

public class VuforiaCapstoneTest extends LinearOpMode
{
    ...
    @Override public void runOpMode()
    {
        ...
        double  targetRange     = -5;        // Distance from camera to target in Inches
        double  targetX         = -5;        // X Distance
        double  targetY         = -5;        // Y Distance
